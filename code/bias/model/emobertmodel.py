...
class emoMyBertModel(BertPreTrainedModel):
    def __init__(self, config, labelnum, maxlen=200, input_type=CLAIM_ONLY, emocred_type = 'EMO_INT'):

        super(emoMyBertModel, self).__init__(config)

        self.emocred_type = emocred_type
        print('********emoMyBert********')
        print(f'emocred_type:  {self.emocred_type}')
